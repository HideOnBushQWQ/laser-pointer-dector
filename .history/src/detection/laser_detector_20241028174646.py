...
class LaserDetector:
    ...
    def detect_laser(self, frame):
        ...
        # Define red color range and create a mask for red regions
        ...
        for contour in contours:
            ...
            if cv2.contourArea(contour) > self.area_threshold:
                ...
                # Debug output: Show red area and brightness values for troubleshooting
                print(f"Red Area Detected: {(x, y, w, h)}, Brightness: {center_brightness}")
