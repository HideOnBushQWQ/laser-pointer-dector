...
def detect_laser_point(frame):
    ...
    # Define HSV range for bright red based on the new config
    lower_red = np.array([CONFIG["red_hue_min"], CONFIG["saturation_min"], CONFIG["value_min"]])
    upper_red = np.array([CONFIG["red_hue_max"], 255, 255])
